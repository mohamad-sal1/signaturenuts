...
const CONFIG_CATALOG_SHEET_API =
  'https://script.google.com/macros/s/AKfycbzU99e_fivNkgN7CFUdF-UkPSgZDIe95XhJA1NMnL3wqPr-rtNua4rlWesy1s3tvdQw/exec';
...
export default function App() {
  ...
  const [productCustomWeightInputMap, setProductCustomWeightInputMap] =
    useState({});
      ...
      <main className='main-feed-container'>
        {isDataLoading ? (
          <div className='loading-spinner-box'>
            ...
            <p
              style={{ color: '#8E847E', fontSize: '13px', fontWeight: '500' }}
            >
          ...
          <div>
            ...
            targetedActiveCategoryNode.subcategories.length > 0 ? (
              targetedActiveCategoryNode.subcategories.map((subGroupTitle) => {
                const associatedGridProducts = productsToRenderInFeed.filter(
                ...
                return (
                  ...
                  >
                    <div className='subcategory-header-row'>
                      ...
                      <h2 className='subcategory-headline'>{subGroupTitle}</h2>
                    </div>
